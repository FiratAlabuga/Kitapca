...
import 'package:hackathon_social/screens/book_page_view.dart';
import 'package:hackathon_social/screens/chat_room.dart';
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            hintText: 'Sana uygun olan kitabı bul...',
                            hintStyle: TextStyle(
                              fontSize: 16.0,
                            ),
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        showDialog(
                            ...
                            builder: (context) {
                              return AlertDialog(
                                title: Text('Neler ile arama yapabilirsin:'),
                                content: Text(
                                    'Kitap Adı\nYazar\nDers Adı\nYıl/Yarıyıl\nBölüm'),
                                actions: <Widget>[
                                  FlatButton(
